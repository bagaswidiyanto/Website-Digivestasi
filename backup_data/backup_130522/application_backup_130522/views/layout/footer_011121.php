...
<footer class="boxed-footer">
      ...
      <div id="whatsapp-chat-popup" class="animated bounceOutDown" style="z-index: 999999; display: none;">
        ...
        <div id="list-chat-section" class="list-chat-section animated fadeIn" style="display: block;">
          ...
          <div class="chat-section">
                    <?php foreach($this->db->query("SELECT a.*,a.user as namas, s.first_name as namadepan ,c.nama as cabang FROM tbl_chat_wa a  left join log_branch c ON a.branch=c.kode left join sys_users s ON s.id=a.user order by a.id asc")->result() as $sec2) { ?>
            ...
            <?php foreach($this->db->query("SELECT a.*,a.user as namas,s.first_name as namadepan,c.nama as cabang FROM tbl_chat_wa a  left join log_branch c ON a.branch=c.kode left join sys_users s ON s.id=a.user order by a.id asc")->result() as $sec3) { ?>
          ...
          <div class="inside-chat-section">
            ...
            <div class="chat">
              <div class="inside-chat">
                <span><?=(@$_GET['lang']!='eng') ? 'Halo, Saya '.ucwords(strtolower($sec3->nama)).', Customer Service dari GAP '.strtoupper($sec3->cabang)  : "Hello, I'm ".ucwords(strtolower($sec3->nama)).', Customer Service from Branch '.strtoupper($sec3->cabang) ;?>
                  </span>
              </div>
              <div class="time">
    ...
    <!-- //tutup wa -->
        ...
        <div class="column  menu xs-100 sm-50 md-33 lg-25 xl-25 ">
                <!-- <h3>Information</h3> -->
                <h3> <?=(@$_GET['lang']!='eng') ?  'Media Sosial' :  'Social Media';?></h3>
                        <div class="column-menu-wrap">
        <ul>
        		 <?php foreach ($sosmed->result() as $sos ) { ?>
        	<li><a href="<?=$sos->link?>"><i style="margin-right: 5px; font-size: 5px; top: -1px" data-icon="&#xe643;"></i><?= $sos->name ?></a></li>
        	<?php } ?>
        ...
        <ul>
            ...
            <div class="column  menu xs-100 sm-50 md-33 lg-25 xl-25 ">
                ...
                <h3> <?=(@$_GET['lang']!='eng') ?  'Kontak' :  'Contact';?></h3>
                        <div class="column-menu-wrap">
                        <ul>
                                    <li><i style="margin-right: 5px !important; color: rgb(68, 67, 73) !important; font-size: 16px !important;" data-icon="&#xe61a;"></i><?=strip_tags($contactus->address);?></li>
                                                <!-- <li><i style="margin-right: 5px; color: rgb(68, 67, 73); font-size: 16px" data-icon="&#xe61a;"></i>Sialkot - 51310, Pakistan</li> -->
                                                <li><a href="<?=base_url()?>"><i style="margin-right: 5px; color: rgb(68, 67, 73); font-size: 16px" data-icon="&#xe698;"></i><?=$contactus->email;?></a></li>
                                                <li><i style="margin-right: 5px; color: rgb(68, 67, 73); font-size: 16px" data-icon="&#xe637;"></i><?=$contactus->website;?></li>
                        </ul>
                        </div>
            </div>
