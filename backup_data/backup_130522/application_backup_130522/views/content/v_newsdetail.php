            ...
            <div class="jeg_share_top_container">
              <div class="jeg_share_button clearfix">
                ...
                <div class="jeg_sharelist">
                  ...
                  <a onclick="is_share(<?=$news->id;?>,'whatsapp')" href="//api.whatsapp.com/send?text=<?= $news->Title .' '. base_url() . 'news/detail/' . $news->slug ?>" rel="nofollow" data-action="share/whatsapp/share" class="jeg_btn-whatsapp ">
                  <img src="<?= base_url() ?>assets/image/whatsapp_ic.png" style="padding: 8px">
                  </a>
                  <a onclick="is_share(<?=$news->id;?>,'telegram')" href="https://telegram.me/share/url?url=<?=$news->Title .' '. base_url() . 'news/detail/' . $news->slug ?>" rel="nofollow" class="jeg_btn-telegram ">
                ...
                <div class="row tabcontent" style="margin-bottom: 5%;" id="<?=$pk->subKategori;?>">
                  ...
                  <div class="col-sm-6 text-berita">
                   <a href="<?= base_url() . 'news/detail/' . $pk->slug ?>" style="color: black;text-decoration: none;">
                    ...
                    <p style="color: grey;font-size: 12px;"><?=date('H:i, d M Y',strtotime($pk->created_date));?></p>
                    <div class="text-content-berita">
                      <?=$ket;?>
                    </div>
                  </a>
