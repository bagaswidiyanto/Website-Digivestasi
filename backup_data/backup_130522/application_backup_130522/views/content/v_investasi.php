...
<!--				<img src="<?= base_url() ?>assets/image/Investasi.png" class="d-block w-100" alt="..." style="padding: 40px;">-->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->
<!--</div>-->
	...
	<div class="container">
        ...
        <div class="col-sm-4">
        	...
        	<div id=sidebar>
        		...
        		<div class="blocks">
        			<div class="cms-block xs-100 sm-50 md-50 lg-25 xl-26">
        				<div class="box-heading" style="font-size: 24px;font-weight: 600;text-transform: none;">Berita Populer</div>
