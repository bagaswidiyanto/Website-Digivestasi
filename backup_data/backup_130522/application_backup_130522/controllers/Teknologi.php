...
class Teknologi extends MY_Controller {
	...
	public function index()
	{
		...
		$query = $this->db->where('idKategori', '4')->get('tbl_posts');
		$jml = $query->num_rows();
	...
	public function detail(){
		$this->load->view('content/v_teknologi');
	}
}
