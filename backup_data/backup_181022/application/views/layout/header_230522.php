                ...
                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                 <?php foreach ($this->db->query("SELECT * FROM tbl_sosmed ")->result() as $sos) {
                    if ($sos->name=='Instagram') {?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_ig.png" style="margin-left: 10px;"> Instagram <p style="margin-left: 25px;font-size: 10px;">@digivestasi</p></a>
                        <hr class="dropdown-divider">
                    <?php }else if ($sos->name=="Facebook"){?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_fb.png" style="margin-left: 10px;"> Facebook <p style="margin-left: 25px;font-size: 10px;">Digivestasi</p></a>
                        <hr class="dropdown-divider">
                    <?php }else if ($sos->name=='Twitter') { ?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_tw.png" style="margin-left: 10px;"> Twitter <p style="margin-left: 25px;font-size: 10px;">@digivestasi</p></a>
                        <hr class="dropdown-divider">
                    <?php }else if ($sos->name=='Youtube') { ?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_yt.png" style="margin-left: 10px;"> Youtube <p style="margin-left: 25px;font-size: 10px;">Digivestasi - Digital Investasi</p></a>
                        <hr class="dropdown-divider">
                    <?php } else if ($sos->name=='Tiktok') { ?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/tik_icon.png" style="margin-left: 10px;"> Tiktok <p style="margin-left: 25px;font-size: 10px;">@digivestasi</p></a>
                        <hr class="dropdown-divider">
                    <?php } else if ($sos->name=='Telegram') { ?>
                        <a class="ddropdown-item waves-effect waves-light" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/tele_icon.png" style="margin-left: 10px;"> Telegram <p style="margin-left: 25px;font-size: 10px;">Digivestasi</p></a>
                    <?php }
                }?>
...
<ul class="navbar-nav flex-row justify-content-center flex-nowrap">
    <?php foreach ($this->db->query("SELECT * FROM tbl_sosmed ")->result() as $sosm) {
        ...
        <?php }else if ($sosm->name=='Twitter') { ?>
            <a href="<?= $sosm->link ?>"><img src="<?= base_url() ?>assets/image/tw_icon.png" style="width: 17px;height: auto;margin-top: -10px;margin-right: 5px;"></a>
        <?php }else if ($sosm->name=='Youtube') { ?>
            <a href="<?= $sosm->link ?>"><img src="<?= base_url() ?>assets/image/yt_icon.png" style="width: 17px;height: auto;margin-top: -10px;margin-right: 5px;"></a>
        <?php }else if ($sosm->name=="Facebook"){?>
            <a href="<?= $sosm->link ?>"><img src="<?= base_url() ?>assets/image/fb_icon.png" style="width: 17px;height: auto;margin-top: -10px;margin-right: 5px;"></a>
        <?php }else if ($sosm->name=="Tiktok") { ?>
            <a href="<?= $sosm->link ?>"><img src="<?= base_url() ?>assets/image/tik_icon.png" style="width: 15px;height: auto;margin-top: -10px;margin-right: 5px;"></a>
        <?php } 
    }?>
</ul>
</div>
