...
<!--				<img src="<?= base_url() ?>assets/image/Cryptocurrency.png" class="d-block w-100" alt="..." style="padding: 40px;">-->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->
<!--</div>-->
...
<div class="col-lg-12" style="margin-top: 5%; background: linear-gradient(90.05deg, #FFB947 0.05%, #FF9F48 99.44%);height: 100px;" hidden>
	<div class="container" style="padding-top: 2%;">
		<div class="row" id="tab">
			<!-- <div hidden="true">
				<button class="tabs-sub-kategori active" data-toggle="tab" onclick="getBerita(0)" data-tabs=".gtabs.demo" data-tab=".tab-0">Semua Berita</button>
			</div> -->
			

			<?php foreach ($this->db->query("SELECT * FROM tbl_subkategori order by id asc")->result() as $sub) {?>

				<button class="tabs-sub-kategori tablinks" onclick="getBerita(<?=$sub->id;?>)"><?=$sub->kategori;?></button>
				<!-- <a href="#<?=$sub->id?>" class="tabs-sub-kategori" data-toggle="tab"><?=$sub->kategori;?></a> -->
...
<div id="bottom-modules" style="margin-bottom: 195px;">
	<div class="container">
							...
							if(($berita->num_rows()) >0){ 
                                ...
                                <div class="row tabcontent" style="margin-bottom: 5%;" id="<?=$p->subKategori;?>">
                                	<a href="<?= base_url() . 'news/detail/' . $p->slug ?>" class="linkk">
                                		<div class="col-sm-4">
                                			<i><img style="margin-right: 5px; top: -1px" src="https://admin103.digivestasi.com/upload/posts/<?= $p->image ?>" width="210" height="auto" alt="" title="" /></i>
                                		</div>
                                	</a>
        ...
        <div class="col-sm-4">
        	...
        	<div id=sidebar>
        		...
        		<div class="box-heading" style="font-size: 24px;font-weight: 600;text-transform: none;margin-bottom: 15px;padding-top: 5px;margin-top: 0px;">Tag Populer</div>
        		...
        		<div class="blocks">
        			<div class="cms-block xs-100 sm-50 md-50 lg-25 xl-26">
        			<div class="box-heading" style="font-size: 25px;font-weight: 600;text-transform: none;margin-bottom: 10px;">Berita Populer</div>
    ...
    <script>
      ...
      // function getBerita(evt, tabName) {
