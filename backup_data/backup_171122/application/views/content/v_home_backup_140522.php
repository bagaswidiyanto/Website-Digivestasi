...
<div class="col-lg-12">
    <div class="container" style="padding-top: 1%;padding-bottom: 1%;background-color: #000000;">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-sm-12 text-berita">
                                    <a href="<?= base_url() . 'news/detail/' . $beritas->slug ?>" style="color: black;text-decoration: none;">
                                      <p style="font-size: 18px;font-style: bold !important;font-weight: 600;"><?= substr($beritas->Title, 0, 100) ?></p>
...
<!-- iklan -->
    <div class="col-sm-4">
      ...
      <div id=sidebar>
        ...
        <div class="blocks">
            <!-- <div class="cms-block xs-100 sm-50 md-50 lg-25 xl-26"> -->
                <img src="<?=base_url()?>assets/image/new_image/pubg.png" class="img-fluid" alt="" />
...
<div id="bottom-modules" style="margin-bottom: 195px;">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => "https://www.googleapis.com/youtube/v3/search?order=date&part=snippet&channelId=UCQBTOwj6Ol74mTvnkRsjckQ&maxResults=1&key=AIzaSyC-8iZ3kbJTRHbUHkXb5LHe_GdTsnPGgys",
        ...
        <div class="row">
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => "https://www.googleapis.com/youtube/v3/search?order=date&part=snippet&channelId=UCQBTOwj6Ol74mTvnkRsjckQ&maxResults=3&key=AIzaSyC-8iZ3kbJTRHbUHkXb5LHe_GdTsnPGgys",
              CURLOPT_RETURNTRANSFER => true,
              CURLOPT_ENCODING => "",
              CURLOPT_MAXREDIRS => 10,
              CURLOPT_TIMEOUT => 30,
    ...
    <div class="blocks" style="text-align:center;">
        <span class="block-content" style="">
            <img src="<?= base_url() ?>assets/image/new_image/logo_atas.png" width="250" height="auto" />
