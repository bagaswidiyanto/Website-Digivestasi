...
<!--				<img src="<?= base_url() ?>assets/image/Teknologi.png" class="d-block w-100" alt="..." style="padding: 45px;">-->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->
<!--</div>-->
	...
	<div class="container">
        ...
        <div class="col-sm-4">
        	...
        	<div id=sidebar>
        		...
        		<div class="blocks">
        			<div class="cms-block xs-100 sm-50 md-50 lg-25 xl-26">
        			<div class="box-heading" style="font-size: 24px;font-weight: 600;text-transform: none;margin-bottom: 10px;">Berita Populer</div>
