...
<footer class="boxed-footer">
        ...
        <div class="column  newsletter xs-100 sm-50 md-33 lg-25 xl-254 ">
          ...
          <div class="box journal-newsletter text-top " id="journal-newsletter-495805429" style="">
            <div class="box-content" style="background-repeat: repeat; background-position: center top; background-attachment: scroll">
              <span class="newsletter-text" style="font-weight: normal; font-family: Poppins; font-size: 15px; font-style: normal; text-transform: none; color: rgb(255, 255, 255)"><?= (@$_GET['lang'] != 'eng') ?  'Langganan bersama Digivestasi dan dapatkan informasi terupdate, masukkan email kamu di bawah!' :  ' a'; ?></span>
  ...
  <div class="row columns " style="background-attachment: scroll;margin-top:30px; margin-bottom: 2px">
    <!-- <div class="row"> -->
      <div class="col-sm-1"></div>
      <div class="col-sm-2" >
        <img src="<?= base_url() ?>assets/image/gap/digi.png" width="200" height="auto" style="margin-bottom: 10px;"/>
        <div class="box journal-newsletter text-top " id="journal-newsletter-495805429" style="">
          <div class="box-content" style="background-repeat: repeat; background-position: center top; background-attachment: scroll">
            <span class="newsletter-text" style="font-color: white; font-weight: normal; font-family: Poppins; font-size: 14px; font-style: normal; text-transform: none; color: rgb(255, 255, 255)"><?= (@$_GET['lang'] != 'eng') ?  'Digivestasi adalah sebuah media informasi seputar aset digital ' :  'Digivestasi is a medium of information about digital assets '; ?></span>
          </div>
        </div>
      </div>
