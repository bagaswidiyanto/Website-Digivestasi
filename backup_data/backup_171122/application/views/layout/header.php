...
<body>
    ...
    <div class="row" style="padding: 20px;background-color: #232323 !important;">
        <div class="col-4" style="color: #FFFFFF; margin: auto;">
            <img src="<?= base_url() ?>assets/image/new_image/temp_icon.png" width="20" height="20" alt="" />
            32<sup>&deg C</sup> &nbsp; INDONESIA &nbsp;&nbsp;&nbsp; <img src="<?= base_url() ?>assets/image/new_image/jam.png" width="20" height="20" alt="" />
            <?= date('l, d F Y') ?>
        </div>
        ...
        <div class="col" style="margin: auto;" style="color: #FFFFFF">
            ...
            if ($this->session->userdata('user_id')) { ?>
                ...
                <a class="nav-link dropdown-toggle waves-effect waves-light" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hi, <?= $getUser['first_name']; ?>
                </a>
                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                    <a class="ddropdown-item waves-effect waves-light" href="<?= base_url('logout') ?>" style="color: black;text-decoration: none;">Logout </a>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center" style="padding: 20px;background-color: #FFFFFF !important;">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?= base_url() ?>"><img src="<?= base_url() ?>assets/image/new_image/logo_040622.png" width="200" style="height: auto !important;" /></a>
            ...
            <div class="collapse navbar-collapse justify-content-between align-items-center w-100" id="navbarSupportedContent" style="margin-left:-10%;">
                <ul class="navbar-nav mx-auto text-center">
                    <?php foreach ($this->db->query("SELECT * FROM tbl_navigation WHERE parent = 0 AND status = 'Y'")->result() as $key) { ?>
                        <li class="nav-item active" id="berandahome">
                            <a class="nav-link waves-effect waves-light" onclick="getColor(<?= $key->id ?>)" href="<?= ($key->title != 'Beranda') ? base_url() . strtolower($key->slug) : base_url() ?>" onclick="window.location.href='<?= base_url() . $key->slug; ?>/';"><?= $key->title ?></a>
                        </li>
                    <?php } ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <?php foreach ($this->db->query("SELECT * FROM tbl_sosmed ")->result() as $sos) {
                                if ($sos->name == 'Instagram') { ?>
                                    <a class="ddropdown-item waves-effect waves-light" target="_blank" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_ig.png" style="margin-left: 10px;"> Instagram
                                        <p style="margin-left: 25px;font-size: 10px;">@digivestasi</p>
                                    </a>
                                    <hr class="dropdown-divider">
                                <?php } else if ($sos->name == "Facebook") { ?>
                                    <a class="ddropdown-item waves-effect waves-light" target="_blank" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/ic_fb.png" style="margin-left: 10px;"> Facebook
                                        <p style="margin-left: 25px;font-size: 10px;">Digivestasi</p>
                                    </a>
                                    <hr class="dropdown-divider">
                                ...
                                <?php } else if ($sos->name == 'Tiktok') { ?>
                                    <a class="ddropdown-item waves-effect waves-light" target="_blank" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/tik_icon.png" style="margin-left: 10px;"> Tiktok
                                        <p style="margin-left: 25px;font-size: 10px;">@digivestasi</p>
                                    </a>
                                    <hr class="dropdown-divider">
                                <?php } else if ($sos->name == 'Telegram') { ?>
                                    <a class="ddropdown-item waves-effect waves-light" target="_blank" href="<?= $sos->link ?>" style="color: black;text-decoration: none;"><img src="<?= base_url() ?>assets/image/tele_icon.png" style="margin-left: 10px;">
                                        Telegram <p style="margin-left: 25px;font-size: 10px;">Digivestasi</p></a>
                            <?php }
                            } ?>
