...
<div class="col-lg-12">
    <div class="container" style="padding-top: 2%;">
        <div class="row" id="tab">
            ...
            <button class="tabs-sub-kategori tablinks"
                style="font-family: Noto Sans !important;font-style: normal;margin-left: auto;margin-right: auto;"
                onclick="getBerita(<?= $sub->id; ?>,'<?= $sub->kategori; ?>')"><?= $sub->kategori; ?></button>
    ...
    <div id="container" class="j-container">
        <div id="content">
            <h3 class="heading-title">
                <?= (@$_GET['lang'] != 'eng') ?  'Kami adalah Digivestasi' :  'We Are Digivestasi'; ?></h3>
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="text-align:center">
                                <a href="#"><img class="img-responsive"
                                        src="https://admin103.digivestasi.com/upload/company/<?= $contactus->image ?>"
                                        style="width: 40%;height: auto !important;" alt=""></a>
                            </div>
                        </div>
                    </div>
