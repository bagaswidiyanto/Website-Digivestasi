    ...
    <div class="container px-lg-5">
        <div class="row">
            <div class="col-lg-8">
                ...
                $tgl = date('d F Y', strtotime($news_detail->created_date));
                ?>
                <div class="box-single pb-5">
                    ...
                    <div class="entry-sub">
                        <p><?= $news_detail->kategori; ?> <span>- Diposting pada <?= $tgl; ?> Waktu baca 5 menit</span>
                        </p>
                    </div>
                    ...
                    <div class="entry-image my-4">
                        <img src="https://admin103.digivestasi.com/upload/posts/<?= $news_detail->image ?>"
                            class="img-fluid" alt="">
                    </div>
                ...
                <div class="next-article py-5 position-relative px-4">
                    <?php $queryNext = $this->db->query("SELECT * FROM tbl_posts WHERE slug = '" . $id . "'")->row() ?>
                    <?php foreach ($this->db->query("SELECT * FROM tbl_posts WHERE id < '" . $queryNext->id . "' ORDER BY id DESC LIMIT 1")->result() as $nextNews) { ?>
                ...
                <div class="tag-single pt-5">
                    ...
                    <ul class="tags">
                        ...
                        <li><a onclick="getBerita(<?= $tg->id; ?>,'<?= $tg->tag_name ?>')" class="px-3 py-1 text-center"
                                style="cursor: pointer;"><?= $tg->tag_name; ?></a></li>
                        <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            <div class="d-flex align-items-center">
                                <?php
                                $jumlahShare = $news_detail->fb_share + $news_detail->twitter_share + $news_detail->wa_share + $news_detail->telegram_share;
                                ?>
                                <a onclick="is_share(<?= $news_detail->id; ?>,'facebook')"
                                    href="https://www.facebook.com/sharer.php?u=<?= base_url() . 'news/detail/' . $news_detail->slug ?>"
                                ...
                                <a onclick="is_share(<?= $news_detail->id; ?>,'twitter')"
                                    href="https://twitter.com/intent/tweet?text=<?= $news_detail->Title . ' ' . base_url() . 'news/detail/' . $news_detail->slug ?>"
                                ...
                                <a onclick="is_share(<?= $news_detail->id; ?>,'whatsapp')"
                                    href="//api.whatsapp.com/send?text=<?= $news_detail->Title . ' ' . base_url() . 'news/detail/' . $news_detail->slug ?>"
                ...
                <div class="fb-comments" data-href="https://digivestasi.com/news/detail/<?= $news_detail->id ?>"
                ...
                <div class="py-5">
                    ...
                    <div class="more-news mt-3">
                        <div class="row g-4">
                            <?php foreach ($berita_lainnya as $banner2) { ?>
                            <div class="col-4">
                                <a href="<?= base_url() . 'news/detail/' . $banner2->slug ?>">
                                    <div class="box-news">
                                        <div class="img">
                                            <img src="https://admin103.digivestasi.com/upload/posts/thumbnail/<?= $banner2->image ?>"
                                                class="img-fluid" alt="">
                                        </div>
            ...
            <div class="col-lg-4">
                ...
                <a href="<?= $iklan4->url; ?>" target="_blank" title="<?= $iklan4->nama; ?>">
                    <div class="box-advert text-center">
                        <?php if ($iklan4->image != '') { ?>
                        <img src="https://admin103.digivestasi.com/upload/iklan/<?= $iklan4->image; ?>"
                            class="img-fluid w-100" alt="">
                        <?php } else { ?>
                        <img src="<?= base_url() ?>assets/imagenew/385x320.jpg" class="img-fluid w-100" alt="">
                        <?php } ?>
                    </div>
                </a>


                <a href="<?= $iklan5->url; ?>" target="_blank" title="<?= $iklan5->nama; ?>">
                    <div class="box-advert text-center mt-4">
                        <?php if ($iklan5->image != '') { ?>
                        <img src="https://admin103.digivestasi.com/upload/iklan/<?= $iklan5->image; ?>"
                            class="img-fluid w-100" alt="">
                        <?php } else { ?>
                        <img src="<?= base_url() ?>assets/imagenew/385x320.jpg" class="img-fluid w-100" alt="">
                        <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-4 mt-lg-0">
                            <div class="row g-3">
                                ...
                                <?php foreach ($berita_terpopuler as $banner2) { ?>
                                <div class="col-12">
                                    <a href="<?= base_url() . 'news/detail/' . $banner2->slug ?>">
                ...
                <div class="tag mt-4 p-3">
                    ...
                    <?php foreach ($tag as $sub) { ?>
                    <div class="tag-name">
                        <a onclick="getBerita(<?= $sub->id; ?>,'<?= $sub->tag_name ?>')">#<?= $sub->tag_name; ?></a>
                    </div>
                    <?php } ?>
                ...
                <div class="headline py-5">
                    ...
                    <div class="row g-4">
                        ...
                        <?php foreach ($berita_untukmu as $banner2) { ?>
                        <div class="col-lg-12">
