...
<div id="notification"></div><div class="breadcrumb">
        <a href="<?=base_url()?>">Home</a>
         &raquo; <a href="<?=base_url()?>product"><?=(@$_GET['lang']!='eng') ?  'Produk' :  'Product';?></a>
...
<div id="column-left" class="side-column ">
    ...
    <div class="box-heading"><?=(@$_GET['lang']!='eng') ?  'Semua Kategori' :  'All Categories';?></div>
    <div class="box-category">
        <ul>
                            <li>
                                <!-- <a href="<?=base_url()?>product" class="active"><span class="category-name">Surgical Instruments                                                
                                    <span class="product-count">(8107)</span>
                                                        ...
                                                        <a href="<?=base_url()?>product" class="active"><span class="category-name"><?=(@$_GET['lang']!='eng') ?  'Semua Kategori' :  'All Categories';?>                      
                                    <!-- <span class="product-count">(8107)</span> -->
                                            </span>
                                                            <i><span>-</span></i>
                                                        </a>
                <ul><li>
                    ...
                    foreach($this->db->query("SELECT * from tbl_categories")->result() as $p) { ?>
                   ...
                   <!--  <a class="" href="<?=base_url()?>goitre"><span class="category-name">Goitre <span class="product-count">(10)</span></span></a> -->
                    <!-- <a class="" href="<?=base_url()?>goitre"><span class="category-name"><?= $kt->catName ?>  -->
                        <a class="side" id="side_<?= $p->id ?>" onclick="getProfile(<?= $p->id ?>)"><span class="category-name"><?= $p->catName ?> 
